...
import com.test.weeklly.mapsplaces.Place.Photos;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.placeresultlist);
		...
		title.setText(bun.getString("stext"));
		cd = new ConnectionDetector(MainActivity.this);
		search=(EditText)findViewById(R.id.mapsearchet);
		if(bun.getString("src").equals("btn"))
			search.setText(bun.getString("stext"));
		Typeface font = Typeface.createFromAsset(getAssets(), "fonts/leaguegothic.otf");  
	     search.setTypeface(font); 
	     
		nearby=(CheckBox)findViewById(R.id.Searchnearby);
		...
		nearby.setChecked(bun.getBoolean("checked"));
		nearbysearch=(bun.getBoolean("checked"));
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if(bun.getString("activitysrc").equals("eventcreation"))
                in.putExtra("activitysrc", "eventcreation");
                if(bun.getString("activitysrc").equals("venue"))
		...
		protected String doInBackground(String... args) {
			...
			try {
				...
				nearPlaces = googlePlaces.search(gps.getLatitude(),
						gps.getLongitude(), radius, bun.getString("stext"),search.getText().toString(),nearbysearch);
					...
					if(status.equals("OK")){
						...
						if (nearPlaces.results != null) {
							...
							for (Place p : nearPlaces.results) {
								...
								map.put(KEY_VICINITY,p.formatted_address);
								// Place name
								map.put(KEY_NAME, p.name);
							/*	for(Photos ph: p.photos){
								map.put(KEY_PHOTO_REFERENCE, ph.photo_reference.toString());
								break;}*/
